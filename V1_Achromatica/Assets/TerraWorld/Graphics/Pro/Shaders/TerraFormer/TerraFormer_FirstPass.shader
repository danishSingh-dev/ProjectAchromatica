Shader "TerraUnity/TerraFormer"
{
    ...
    SubShader
	{
        ...
        CGPROGRAM
		#pragma surface surf Standard vertex:SplatmapVert finalcolor:SplatmapFinalColor finalgbuffer:SplatmapFinalGBuffer addshadow fullforwardshadows tessellate:tessEdge tessphong:_Phong noinstancing //nolightmap nodirlightmap nodynlightmap halfasview noforwardadd nometa
		...
		#include "TerraFormer_SplatmapCommon.cginc"
	...
	Dependency "AddPassShader" = "Hidden/TerraUnity/TerraFormer_AddPass"
