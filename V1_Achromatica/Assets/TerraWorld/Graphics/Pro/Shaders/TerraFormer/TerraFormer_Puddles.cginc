...
void Puddles (half puddle, inout fixed3 albedo, inout fixed3 normal, inout float smoothness, inout float metallic, float _Smoothness, float _Metallic, fixed3 finalCol, float waterMask)
{
	puddle *= waterMask;
