Shader "Hidden/TerraUnity/TerraFormer_AddPass_Instanced"
{
	Properties
	{
    ...
    SubShader
    {
        ...
        CGPROGRAM
        #pragma surface surf Standard vertex:SplatmapVert finalcolor:SplatmapFinalColor finalgbuffer:SplatmapFinalGBuffer decal:add //addshadow fullforwardshadows
        ...
        #include "TerraFormer_SplatmapCommon_Instanced_Add.cginc"
