...
namespace TerraUnity.Runtime
{
    ...
    public class SnowManager : MonoBehaviour
    {
        ...
        public void Init()
        {
            ...
            {
                isSnowEnabled = TerrainRenderingManager.isProceduralSnow;
                snowHeight = TerrainRenderingManager.SnowStartHeight;
                snowFalloff = TerrainRenderingManager.HeightFalloff;
