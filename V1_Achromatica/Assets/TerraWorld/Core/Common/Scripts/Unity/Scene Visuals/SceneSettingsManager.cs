...
namespace TerraUnity.Edittime
{
    public class SceneSettingsManager
    {
        ...
        private static GameObject TerraWorldGO { get => TTerraWorldManager.MainTerraworldGameObject; }
        ...
        private static bool destroyComponents = true;
        ...
        public static void SwitchDayNightControl(FXParams fxParams, bool forcedUpdate = false)
        {
            ...
            else if (TerraWorldManager.timeOfDayMode == 2)
            {
                globalTimeManager.enabled = true;
            ...
            if (forcedUpdate)
                timeOfDay.UpdateAtmosphere(true);
        ...
        {
            if (IsTerrainAvailable())
                TerrainRenderingManager.isProceduralSnow = fxParams.hasSnow;
        ...
        public static void DisableVisualFX()
        {
            ...
            {
#if UNITY_STANDALONE_WIN
                if (atmosphericScatteringSun != null) MonoBehaviour.DestroyImmediate(atmosphericScatteringSun);
