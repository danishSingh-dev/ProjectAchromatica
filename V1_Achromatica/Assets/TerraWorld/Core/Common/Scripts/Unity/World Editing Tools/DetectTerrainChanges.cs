...
namespace TerraUnity.Runtime
{
    ...
    public class DetectTerrainChanges : MonoBehaviour
    {
        ...
        public static void SyncLayerWithTerrain(Vector2 mousePosition, TScatterLayer.MaskData[] filter)
        {
        ...
        public static void SyncLayersWithTerrain (Vector2 mousePosition, bool affectGPULayers = true, bool affectGrassLayers = true, List<TScatterLayer.MaskData[]> filters = null)
        {
            if (Application.isPlaying) return;
        ...
        public static void SyncLayersWithTerrain (bool syncGPU = true, bool syncGrass = true, List<TScatterLayer.MaskData[]> filters = null)
        {
            if (Application.isPlaying) return;
