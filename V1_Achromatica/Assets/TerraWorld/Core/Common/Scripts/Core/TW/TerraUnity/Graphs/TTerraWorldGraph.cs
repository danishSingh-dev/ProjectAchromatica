...
namespace TerraUnity.Edittime
{
    ...
    public class TTerraWorldGraph
    {
       ...
       // public RenderingParams _renderingParams1;
       // public FXParams _VFXParams;
        ...
        public void SaveGraphAsTemplate(string path)
        {
            TDebug.TraceMessage();
            templateIgnoreList.Ignore_AreaGraph = true;
            SaveGraph(path);
        }
        ...
        public void SaveGraph(string path)
        {
            ...
            {
                _timeOfDayParams = TTerraWorldManager.TimeOfDayManagerScript.GetParams();
                _timeOfDayParamsSaved = true;
            }
            else
                _timeOfDayParamsSaved = false;

           // _VFXParams = SceneSettingsManager.FXParameters;
           // _renderingParams1 = TerrainRenderingManager.RenderingParams;
